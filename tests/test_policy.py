...
class RepositoryPolicyTests(unittest.TestCase):
    ...
    def test_operational_and_scholarly_do_not_overlap(self) -> None:
        policy = load_policy()
        ...
        self.assertFalse(operational & scholarly)

    def test_policy_names_are_latin_safe(self) -> None:
        policy = load_policy()
        ...
        for name in names:
            self.assertRegex(name, LATIN_SAFE_RE)
